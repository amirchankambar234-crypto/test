...
$webhook = "https://discord.com/api/webhooks/1464644525132742688/Nklo9KcxdCsJF4wn7QX7JkqT5w4diK_iax_V1m_zoFJtStdrYBF6-FYsjSakPULKJW0T"   # ← ВСТАВЬ СВОЙ ПОЛНЫЙ WEBHOOK
